...
const Lsecond = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    //   answer: ans.answer,
    // });
    if (ans.answer === user.games.level2.answer) {
      ...
      setCount2(count2 + 1);
      toast.success(`Incorrect answer,left attempt ${5-count2}`);
      if(count2>=5)
      {
        setstateCom(0);
        setCount1(0);
  ...
  const Handlemove=()=>{
    document.getElementById("clue").innerHTML =user.games.level2.question;
  }
  const Handleout=()=>{
